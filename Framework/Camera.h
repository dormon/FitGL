...
class PerspectiveCamera: public Camera, public std::enable_shared_from_this<PerspectiveCamera>{
public:
...
typedef std::shared_ptr<PerspectiveCamera> PerspectiveCameraShared;